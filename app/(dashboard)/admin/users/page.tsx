  ...
  return (
    <div className="space-y-8">
      ...
      <p className="text-lg text-gray-600">
        Effortlessly manage all users, including employees, suppliers, wholesalers, and customers.
      </p>
      
      <CreateUserForm />

      <div className="bg-white p-6 rounded-xl shadow-lg border border-gray-200">
        <h2 className="text-2xl font-semibold mb-5 text-gray-800">Existing Users</h2>
            ...
            <table className="min-w-full text-left bg-white border-collapse">
              <thead>
                <tr className="bg-gray-50 border-b border-gray-200 text-gray-600 uppercase text-sm leading-normal">
                  ...
                  <th className="py-3 px-4 font-semibold text-right">Actions</th> {/* Align to right */}
                </tr>
              </thead>
              <tbody className="text-gray-700 text-base font-light">
                {users.map((user) => (
                  <tr key={user.id} className="border-b border-gray-200 hover:bg-gray-50 transition-colors duration-150 ease-in-out">
                    ...
                    <td className="py-3 px-4">{format(new Date(user.createdAt), 'dd MMM yyyy, hh:mm a')}</td>
